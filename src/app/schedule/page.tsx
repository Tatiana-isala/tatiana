...
// import { getAllClassrooms, getScheduleForClassroom, getAllCourses, createScheduleItem, deleteScheduleItem } from '@/lib/db';
...
//                 className={`p-3 rounded cursor-pointer ${selectedClassroom === classroom.id ? 'bg-blue-100 border-l-4 border-blue-500' : 'hover:bg-gray-100'}`}
//               >
//                 {classroom.name}
//               </div>
//             ))}
...
//                   disabled={!newItem.courseId}
//                   className="mt-3 bg-blue-500 text-white py-1 px-4 rounded disabled:bg-gray-300"
//                 >
//                   Ajouter
//                 </button>
//               </div>
...
//             </>
//           ) : (
//             <p>Sélectionnez une classe pour voir son horaire</p>
//           )}
//         </div>
//       </div>
//     </div>
