...
//     setLoading(true);
//     try {
//       await Promise.all(selectedClassrooms.map(classroomId => 
//         setFeeStructure({
//           classroomId,
//           ...feeData
//         })
...
//       <h1 className="text-2xl font-bold mb-6">Gestion des frais scolaires</h1>
      
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
//         <div>
//           <h2 className="text-xl font-semibold mb-4">Définir les frais</h2>
          
//           <form onSubmit={handleSubmit} className="space-y-4">
//             <div>
//               <label className="block mb-2 font-medium">Sélectionner les classes</label>
//               <select
//                 multiple
...
//                 )}
//                 className="border rounded px-4 py-2 w-full h-64"
//                 disabled={loading}
//               >
//                 {classrooms.map(cls => (
...
//             <div>
//               <label className="block mb-2 font-medium">Frais scolaires (CDF)</label>
//               <input
//                 type="number"
...
//             <div>
//               <label className="block mb-2 font-medium">Minerval (CDF)</label>
//               <input
//                 type="number"
...
//             <div>
//               <label className="block mb-2 font-medium">Frais connexes (CDF)</label>
//               <input
//                 type="number"
...
//             >
//               {loading ? 'Enregistrement...' : 'Enregistrer les frais'}
//             </button>
...
//         <div>
//           <h2 className="text-xl font-semibold mb-4">Frais définis par classe</h2>
          
//           {existingFees.length === 0 ? (
//             <p>Aucune structure de frais définie</p>
//           ) : (
...
//                     <th className="py-2 px-4 border">Frais scolaires</th>
//                     <th className="py-2 px-4 border">Minerval</th>
//                     <th className="py-2 px-4 border">Frais connexes</th>
//                     <th className="py-2 px-4 border">Total</th>
//                   </tr>
//                 </thead>
//                 <tbody>
//                   {existingFees.map(fee => {
//                     const classroom = classrooms.find(c => c.id === fee.classroomId);
//                     return (
//                       <tr key={fee.id} className="hover:bg-gray-50">
//                         <td className="py-2 px-4 border">
//                           {classroom?.name || 'Classe inconnue'}
//                         </td>
//                         <td className="py-2 px-4 border text-right">{fee.schoolFee.toLocaleString()} CDF</td>
//                         <td className="py-2 px-4 border text-right">{fee.minerval.toLocaleString()} CDF</td>
//                         <td className="py-2 px-4 border text-right">{fee.otherFees.toLocaleString()} CDF</td>
//                         <td className="py-2 px-4 border text-right font-medium">
//                           {(fee.schoolFee + fee.minerval + fee.otherFees).toLocaleString()} CDF
//                         </td>
//                       </tr>
//                     );
//                   })}
...
// import { useState, useEffect } from 'react';
// import { getAllClassrooms, FeeStructure, setFeeStructure, getAllFeeStructures, Classroom } from '@/lib/db';
// import { FaSchool, FaMoneyBillWave, FaFileInvoiceDollar, FaSave, FaSearch } from 'react-icons/fa';
