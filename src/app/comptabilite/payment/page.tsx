...
//                     >
//                       <div>
//                         <p className="font-medium">{student.nom} {student.postNom} {student.prenom}</p>
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const [parent, currentFeeStructure, currentPayments] = await Promise.all([
      selectedStudent.tuteurId ? getUserById(selectedStudent.tuteurId) : Promise.resolve(null),
      ...
      try {
        await sendPaymentConfirmationEmail(
          ...
          `${selectedStudent.nom} ${selectedStudent.prenom}`,
          {
            ...
            date: paymentRecord.createdAt, // Utilise la date du paiement
