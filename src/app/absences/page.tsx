...
// import { getClassroomsByTeacher, getClassroomsBySection,getClassroomsForTeacher,Classroom } from '@/lib/db';
...
//           <div key={classroom.id} className="border rounded-lg p-4 hover:shadow-md">
//             <h2 className="text-xl font-medium mb-2">{classroom.name}</h2>
