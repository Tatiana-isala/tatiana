...
//     doc.setFontSize(10)
//     doc.setFont('helvetica', 'normal')
//     doc.text(`Nom complet: ${data.student.nom} ${data.student.postNom} ${data.student.prenom}`, margin, 60)
//     doc.text(`Classe: ${data.classroom.name}`, margin, 66)
//     doc.text(`Matricule: ${data.student.matricule}`, margin, 72)
//     doc.text(`Date de naissance: ${new Date(data.student.dateNaissance).toLocaleDateString('fr-FR')}`, margin, 78)
...
//       didDrawPage: (data: any) => { // Type temporaire any pour contourner l'erreur
//         // Pied de page avec moyenne générale
//         if (data.pageNumber === data.pageCount) {
//           const footerY = data.cursor?.y ? data.cursor.y + 20 : doc.internal.pageSize.getHeight() - 20
...
//           // Signature
//           doc.text('Signature du titulaire: ________________________', pageWidth - margin - 80, footerY + 40)
//         }
//       }
//     })
